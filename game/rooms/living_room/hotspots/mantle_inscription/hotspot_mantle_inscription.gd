...
func _on_click() -> void:
	...
	await C.player.say("There's an inscription on the mantle: 'In this hearth, warmth and secrets abide.'")
...
func _on_right_click() -> void:
	await C.player.say("Words carved into the stone mantle above the fireplace.")

...
func _on_click() -> void:
	...
	await C.player.say("A birthday cake with candles... it was eaten recently. Whose birthday was it?")
...
func _on_right_click() -> void:
	await C.player.say("The cake has 'Happy Birthday' written on it. I wonder who the celebration was for...")

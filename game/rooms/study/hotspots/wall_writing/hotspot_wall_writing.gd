...
func _on_click() -> void:
	...
	await C.player.say("Someone scratched numbers into the wall: '4 _ _ _'. A partial code?")
...
func _on_right_click() -> void:
	await C.player.say("Faint scratches on the wall... looks like someone tried to write a code.")
